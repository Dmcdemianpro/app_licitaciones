    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900 text-slate-50">
      <header className="flex items-center justify-between border-b border-white/10 bg-white/5 px-6 py-4 backdrop-blur">
        <div className="flex items-center gap-4">
          <SidebarTrigger />
          <div>
            <p className="text-xs uppercase tracking-[0.25em] text-indigo-200">Configuración</p>
            <h1 className="text-3xl font-bold text-white">Preferencias del sistema</h1>
            <p className="text-sm text-slate-200">Ajustes generales y notificaciones.</p>
          </div>
        </div>
      </header>
      ...
      <div className="flex-1 bg-gradient-to-b from-white/5 via-white/0 to-white/0 p-6">
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-6">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="flex items-center justify-between rounded-lg border border-white/15 bg-white/5 p-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-300">Alertas en tu correo</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between rounded-lg border border-white/15 bg-white/5 p-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-300">Notificaciones en navegador</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between rounded-lg border border-white/15 bg-white/5 p-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-300">Envía un resumen cada semana</p>
                  </div>
                  <Switch
          ...
          <Card className="border-white/10 bg-white/5 text-white shadow-xl backdrop-blur">
            ...
            <CardContent className="rounded-lg border border-dashed border-white/20 bg-white/5 p-6 text-sm text-slate-200">
